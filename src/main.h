...
public:
    ...
    {
        // SperoCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // SperoCoin: get transaction coin age
...
public:
    ...
    // SperoCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // SperoCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // SperoCoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // SperoCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // SperoCoin: block index flags
    enum
    {
